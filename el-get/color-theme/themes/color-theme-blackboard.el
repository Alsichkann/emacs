  ...
  (color-theme-install
   '(color-theme-blackboard
	 (
	  ...
	  (border-color . "black")
	  (cursor-color . "#A7A7A7")
	  (foreground-color . "#f2f8ec")
	  (mouse-color . "sienna1"))
	 ;; (default ((t (:background "#0C1021" :foreground "#F8F8F8"))))
	 (default ((t (:background "darkslategrey" :foreground "#e9ecad"))))
	 (blue ((t (:foreground "blue"))))
	 (bold ((t (:bold t))))
	 (bold-italic ((t (:bold t))))
	 (border-glyph ((t (nil))))
	 (buffers-tab ((t (:background "#0C1021" :foreground "#e9ecad"))))
	 (font-lock-builtin-face ((t (:foreground "#e9ecad"))))
